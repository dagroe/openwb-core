...
class FoxEssH3ProInverter(AbstractInverter):
    ...
    def update(self, client: ModbusTcpClient_) -> None:
        ...
        # MPPT1 + MPPT2 + MPPT3 Power
        power = sum([client.read_holding_registers(
            reg, ModbusDataType.INT_32, unit=unit)
            for reg in [39329, 39333, 39337]]) * -1
        # Gesamt Produktion Wechselrichter unsigned integer in kWh * 0,1
        exported = client.read_holding_registers(39601, ModbusDataType.UINT_32, unit=unit) * 100
